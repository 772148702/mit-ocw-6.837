...
public:
  ...
  friend Vec3f operator+(const Vec3f &v1, const float f) {
	  Vec3f v2; Add(v2, v1, f); return v2; }
  friend Vec3f operator-(const Vec3f &v1, const float f) {
	  Vec3f v2; Sub(v2, v1, f); return v2; }
  ...
  friend void Add(Vec3f &a, const Vec3f &b, const float c) {
	  a.data[0] = b.data[0] + c;
	  a.data[1] = b.data[1] + c;
	  a.data[2] = b.data[2] + c; }
  friend void Sub(Vec3f &a, const Vec3f &b, const Vec3f &c) {
    ...
    a.data[1] = b.data[1] - c.data[1];
    a.data[2] = b.data[2] - c.data[2]; }
  friend void Sub(Vec3f &a, const Vec3f &b, const float c) {
	  a.data[0] = b.data[0] - c;
	  a.data[1] = b.data[1] - c;
	  a.data[2] = b.data[2] - c; }
